...
final class MenuFrontendConfig {
   ...
   * @param ScopeEnum $scope Portée des données (personal, team, global, restricted)
  ...
  public function __construct(public bool $enabled, public string $label, public string $entity, public ?string $icon = null, public int $order = 0,
    public array $roles = [], public bool $display = true, public int $cardinality = self::UNLIMITED, public ScopeEnum $scope = ScopeEnum::PERSONAL,
